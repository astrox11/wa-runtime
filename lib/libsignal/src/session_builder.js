import { OURS, THEIRS } from './base_key_type.js';
import { SENDING } from './chain_type.js';
import SessionRecord, { createEntry } from './session_record.js';
import { deriveSecrets } from './crypto.js';
import { verifySignature, generateKeyPair, calculateAgreement } from './curve.js';
...
class SessionBuilder {
    ...
    async initSession(isInitiator, ourEphemeralKey, ourSignedKey, theirIdentityPubKey,
        ...
        session.indexInfo = {
            ...
            baseKeyType: isInitiator ? OURS : THEIRS,
            closed: -1
        };
        if (isInitiator) {
