...
import { isJidGroup, isJidNewsletter, isJidStatusBroadcast, jidNormalizedUser } from '../WABinary/jid-utils.js'
import { WAMessageStatus, WAProto, type AnyMediaMessageContent, type AnyMessageContent, type DownloadableMessage, type MessageContentGenerationOptions, type MessageGenerationOptions, type MessageGenerationOptionsFromContent, type MessageUserReceipt, type MessageWithContextInfo, type WAMediaUpload, type WAMessage, type WAMessageContent, type WAMessageKey, type WATextMessage } from '../Types/Message.js'
...
export const updateMessageWithReaction = (msg: Pick<WAMessage, 'reactions'>, reaction: proto.IReaction) => {
	...
	const reactions = (msg.reactions || []).filter((r: any) => getKeyAuthor(r.key) !== authorID)
